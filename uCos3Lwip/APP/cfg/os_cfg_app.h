...
#define  OS_CFG_TICK_WHEEL_SIZE           13u               /* Number of 'spokes' in tick wheel                       */
...
#define  OS_CFG_TMR_WHEEL_SIZE            13u               /* Number of 'spokes' in timer wheel                      */


                                                            /* -------------------- DEBUG TABLES -------------------- */
#define  OS_CFG_FLAG_DBG_TBL_SIZE         30u               /* Set to number of expected event flag groups            */
#define  OS_CFG_MEM_DBG_TBL_SIZE          30u               /* Set to number of expected memory partitions            */
#define  OS_CFG_MUTEX_DBG_TBL_SIZE        30u               /* Set to number of expected mutexes                      */
#define  OS_CFG_Q_DBG_TBL_SIZE            30u               /* Set to number of expected message queues               */
#define  OS_CFG_SEM_DBG_TBL_SIZE          30u               /* Set to number of expected semaphores                   */
#define  OS_CFG_TASK_DBG_TBL_SIZE         30u               /* Set to number of expected tasks                        */
#define  OS_CFG_TMR_DBG_TBL_SIZE          30u               /* Set to number of expected timers                       */
